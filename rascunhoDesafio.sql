...
(
	id_employee  NUMERIC(6) IDENTITY(1,1) NOT NULL,
	...
	CONSTRAINT CK_BIRTH_MIN CHECK (DATEDIFF(dd, birth_date, getdate()) >= 6574.5),
	CONSTRAINT CK_BIRTH_MAX CHECK (DATEDIFF(dd, birth_date, getdate()) < 38351.25)
	--CONSTRAINT ALTERADA, 6574.5 E 38351.25 S�O RESPECTIVAMENTE 18 E 105 ANOS EM DIAS QUE S�O USADOS PARA VERIFICAR AS DATAS
	--LIMITES PARA INGRESSAR NA EMPRESA, OS ANOS FORAM MULTIPLICADOS POR 365.5.
);

INSERT INTO EMPLOYEES (name, sex, birth_date, salary)
